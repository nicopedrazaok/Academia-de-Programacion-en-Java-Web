...
<html>
    <head>
        ...
        <title>Programas Desabilitados</title>
    </head>
    <body>
        ...
        <tbody>
            <c:forEach var="programa" items="${lista}">
                <tr>	
                    <td id="listado">${programa.alumno.nombre}, ${programa.alumno.apellido}</td>
                    <td id="listado">${programa.descripcion}</td>
                    <td id="listado"><a href="/AcademiaDeProgramacion/Programas/${programa.nombrePrograma}" class="btn btn-info">Descargar</a></td>
                    <td><a href="/AcademiaDeProgramacion/HabilitarPrograma?idPrograma=${programa.idPrograma}" class="btn btn-success">Habilitar</a></td>       
                </tr>
            </c:forEach>
        </tbody>
    </table>
