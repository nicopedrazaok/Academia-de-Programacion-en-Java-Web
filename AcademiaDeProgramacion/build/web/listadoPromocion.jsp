...
<%@page import="AccesoDatos.GestorPromocionBD"%>
...
<html>
    ...
    <body>
        ...
        <br>      
        <h1>Listado de las Promociones</h1>
        <a href="/AcademiaDeProgramacion/altaPromocion.jsp" class="btn btn-primary">Nueva Promocion</a>
        <table class="table table-bordered table-primary">
            <thead>
            <th scope="row">Nombre de la Promocion</th>
            <th scope="row">Descuento</th>
        </thead>  
        <tbody>
            <c:forEach var="promocion" items="${lista}">
                <tr>
                    <td>${promocion.nombrePromocion}</td>
                    <td>${promocion.descuento}</td>
                    <td><a href="/AcademiaDeProgramacion/ModificarPromocion?idPromocion=${promocion.idPromocion}" class="btn btn-warning">Modificar</a></td>
                    <td><a href="/AcademiaDeProgramacion/EliminarPromocion?idPromocion=${promocion.idPromocion}" class="btn btn-danger">Eliminar</a></td>
                </tr>
            </c:forEach>
        </tbody>
    </table>
