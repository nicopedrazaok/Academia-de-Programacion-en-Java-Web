...
<%@page import="AccesoDatos.GestorDocenteBD"%>
...
<html>
    ...
    <body>
        ...
        <br>
        <h1>Listado de los Docentes</h1>
        <div>
            <a href="/AcademiaDeProgramacion/altaDocente.jsp" class="btn btn-primary">Nuevo Docente</a>
        </div>
        ...
        <tbody>
            <c:forEach var="docente" items="${lista}">
                <tr>
                    ...
                    <td><a href="/AcademiaDeProgramacion/ModificarDocente?idDocente=${docente.idDocente}" class="btn btn-warning">Modificar</a></td>
                    <td><a href="/AcademiaDeProgramacion/EliminarDocente?idDocente=${docente.idDocente}" class="btn btn-danger">Eliminar</a></td>
                </tr>
            </c:forEach>
        </tbody>
    </table>
