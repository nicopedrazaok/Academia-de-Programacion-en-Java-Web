...
<%@page import="AccesoDatos.GestorAlumnoBD"%>
            ...
            <c:forEach var="alumno" items="${lista}">
				<tr>
					...
					<td>${alumno.direccion}</td>
                                        ...
                                        <td>${alumno.email}</td>
					<td><a href="/AcademiaDeProgramacion/ModificarAlumno?idAlumno=${alumno.idAlumno}" class="btn btn-warning">Modificar</a></td>
					<td><a href="/AcademiaDeProgramacion/EliminarAlumno?idAlumno=${alumno.idAlumno}" class="btn btn-danger">Eliminar</a></td>
				</tr>
	   </c:forEach>
            </tbody>
        </table>
