...
<html>
    ...
    <body>
        ...
        <table class="table table-bordered table-primary">
            <thead>           
            <th scope="row">Inscripto</th>
            <th scope="row">Legajo del Inscripto</th>
            <th scope="row">Curso</th>
            <th scope="row">Nombre de nota</th>
        ...
        <tbody>
            <c:forEach var="nota" items="${lista}">
                <tr>	
                    ...
                    <td>${nota.inscripcion.alumno.nombre} ${nota.inscripcion.alumno.apellido}</td>
                    <td>${nota.inscripcion.legajo}</td>
                    <td>${nota.inscripcion.curso.nombreCurso}</td>
                    <td>${nota.nombreNota}</td> 
                    <td>${nota.nota}</td>
                    <td><a href="/AcademiaDeProgramacion/ModificarNota?idNota=${nota.idNota}" class="btn btn-warning">Modificar</a></td>
                    <td><a href="/AcademiaDeProgramacion/EliminarNota?idNota=${nota.idNota}" class="btn btn-danger">Eliminar</a></td>
                </tr>
            </c:forEach>
        </tbody>
    </table>
