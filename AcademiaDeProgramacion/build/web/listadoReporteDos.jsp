...
<html>
    <head>
       ...
       <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/css/bootstrap.min.css" integrity="sha384-TX8t27EcRE3e/ihU7zmQxVncDAy5uIKz4rEkgIXeMed4M0jlfIDPvg6uqKI2xXr2" crossorigin="anonymous">
        <title>Total descuento realizado</title>
    </head>
    <body>
        ...
        <br>  
        <h1>Listado del total de descuento realizados</h1>
        <table class="table table-bordered table-primary">
            <thead class="text-center">
            <th scope="row">Total del descuento realizados</th>
            </thead>
            
            <tbody class="text-center">
                <c:forEach var="reportedos" items="${lista}">
				<tr>
					<td>${reportedos.descuentoTotalRealizado}</td>
				</tr>
	   </c:forEach>
            </tbody>
        </table>
