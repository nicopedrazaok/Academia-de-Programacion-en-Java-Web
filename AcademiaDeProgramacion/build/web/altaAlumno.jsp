...
<html>
    ...
    <body>
        ...
        <br>
        <div class="container">
            <h1>Registrar al Alumno</h1>
        </div>
        <br>
        <form method="POST" action="/AcademiaDeProgramacion/AltaAlumno"> 
            <div class="container">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="txtApellido" id="txtNombre" class="form-control"/>
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="txtDireccion" id="txtDireccion" class="form-control"/></div>
