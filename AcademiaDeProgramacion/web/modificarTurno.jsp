...
<html>
    ...
    <body>
        ...
        <form method="POST" action="/AcademiaDeProgramacion/ModificarTurno"> 
            <input type="hidden" name="txtIdTurno" value="${turnodto.turno.idTurno}" /><br><br>
            <div class="container">
                <div class="form-group col-md-6">
                    <label for="txtNombreTurno">Nombre del Turno: </label>
                    <input type="text" name="txtNombreTurno" id="txtNombreTurno" value="${turnodto.turno.nombreTurno}" class="form-control"/>
                </div>

                <div class="form-group col-md-6">
                    <label for="txtHorario">Horario del turno: </label>
                <input type="text" name="txtHorario" id="txtHorario" value="${turnodto.turno.horario}" class="form-control"/>
                </div>         
