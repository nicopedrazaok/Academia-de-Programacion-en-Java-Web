...
<html>
    ...
    <body>
        ...
        <form method="POST" action="/AcademiaDeProgramacion/ModificarPromocion"> 
            <input type="hidden" name="txtIdPromocion" value="${promociondto.promocion.idPromocion}" />
            <div class="container">
                <div class="form-group col-md-6">
                    <label for="txtNombrePromocion">Nombre de la promocion: </label>
                    <input type="text" name="txtNombrePromocion" id="txtNombrePromocion" class="form-control" value="${promociondto.promocion.nombrePromocion}"/>
                </div>
                <div class="form-group col-md-6">
                    <label for="txtDescuento">Descuento: </label>
                    <input type="text" name="txtDescuento" id="txtDescuento" class="form-control" value="${promociondto.promocion.descuento}"/>
                </div>
