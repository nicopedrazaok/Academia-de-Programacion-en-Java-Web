        ...
        <tbody>
            <c:forEach var="curso" items="${lista}">
                <tr>	
                    ...
                    <td>${curso.precio}</td>
                    <td><a href="/AcademiaDeProgramacion/ModificarCurso?idCurso=${curso.idCurso}" class="btn btn-warning">Modificar</a></td>
                    <td><a href="/AcademiaDeProgramacion/EliminarCurso?idCurso=${curso.idCurso}" class="btn btn-danger">Eliminar</a></td>
                </tr>
            </c:forEach>
        </tbody>
    </table>
