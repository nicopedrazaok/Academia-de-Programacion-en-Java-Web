<%@page import="AccesoDatos.GestorNotaBD"%>
...
<html>
    ...
    <body>
        <jsp:useBean id="gestor" scope="request" class="AccesoDatos.GestorNotaBD"/>
        ...
        <br>
        <div class="container">
            <h1>Registrar Nota Nueva</h1>
        </div>
        <form method="POST" action="/AcademiaDeProgramacion/AltaNota"> 

            <div class="container">
                <div class="form-group col-md-6">
                    <label for="cboInscripcion">Inscripto: </label>
                    <select name="cboInscripcion" class="form-control">
                        <c:forEach var="inscripcion" items="${gestor.listadoInscripcion()}">
                            <option value="${inscripcion.idInscripcion}">${inscripcion.alumno.apellido}, ${inscripcion.alumno.nombre} ${inscripcion.legajo} Curso: ${inscripcion.curso.nombreCurso}</option>
                        </c:forEach>
                    </select>
                </div>

                <div class="form-group col-md-6">
                    <label for="txtNombreNota">Nombre de la Nota: </label>
                    <input type="text" name="txtNombreNota" id="txtNombreNota" class="form-control"/>
                </div>

                <div class="form-group col-md-6">
                    <label for="txtNota">Nota: </label>
                    <input type="number" name="txtNota" id="txtNota" class="form-control"/>
                </div>  
