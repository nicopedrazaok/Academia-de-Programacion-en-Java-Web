<%@page import="Modelo.ReporteCinco"%>
...
<html>
    <head>
        ...
        <title>Total del descuento a los alumnos</title>
    </head>
    <body>
        ...
        <br>  
        <div class="container">
            <h1>Listado del total de descuento de los alumnos</h1>
        </div>       
        <table class="table table-bordered table-primary">
            <thead>
            <th scope="row">Alumnos</th>
            <th scope="row">Total del descuento</th>
        </thead>            
        <tbody>
            <c:forEach var="reportecinco" items="${lista}">
                <tr>
                    <td>${reportecinco.alumno}</td>
                    <td>${reportecinco.totalDescuento}</td>
                </tr>
            </c:forEach>
        </tbody>
    </table>
