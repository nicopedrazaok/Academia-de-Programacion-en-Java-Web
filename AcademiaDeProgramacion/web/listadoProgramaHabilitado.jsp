        ...
        <tbody>
            <c:forEach var="programa" items="${lista}">
                <tr>	
                    ...
                    <td><a href="/AcademiaDeProgramacion/DesabilitarPrograma?idPrograma=${programa.idPrograma}" class="btn btn-warning">Desabilitar</a></td>  
                </tr>
            </c:forEach>
        </tbody>
    </table>
