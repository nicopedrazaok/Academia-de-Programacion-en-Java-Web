<%@page import="AccesoDatos.GestorCursoBD"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<jsp:useBean id="gestor" scope="request" class="AccesoDatos.GestorCursoBD"/>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <br>
        <form method="POST" action="/AcademiaDeProgramacion/AltaCurso"> 
            <div class="container">
                <div class="form-group col-md-6">
                    <label for="txtNombreCurso">Nombre del Curso: </label>
                    <input type="text" name="txtNombreCurso" class="form-control" id="txtNombreCurso"/>
                </div>

                <div class="form-group col-md-6">
                    <label for="cboDocente">Docente: </label>
                    <select name="cboDocente" class="form-control" >
                        <c:forEach var="docente" items="${gestor.listadoDocente()}">
                ...
                <div class="form-group col-md-6">
                    <label for="txtPrecio">Precio del Curso: </label>
