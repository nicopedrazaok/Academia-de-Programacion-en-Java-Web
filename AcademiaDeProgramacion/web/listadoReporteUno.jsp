...
<html>
    <head>
        ...
        <title>Facturacion total por curso</title>
    </head>
    <body>
        ...
        <br>  
       <h1>Listado de facturacion total por cada curso</h1>
        <table class="table table-bordered table-primary">
            <thead>
            <th scope="row">Curso</th>
            <th scope="row">Facturacion total por curso</th>
            </thead>
            
            <tbody>
            <c:forEach var="reporteuno" items="${lista}">
				<tr>
                                        <td>${reporteuno.curso}</td>
					<td>${reporteuno.facturacionTotal}</td>
				</tr>
	   </c:forEach>
            </tbody>
        </table>
