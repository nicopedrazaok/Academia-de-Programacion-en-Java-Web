...
<html>
    ...
    <body>
        ...
        <form method="POST" action="/AcademiaDeProgramacion/ModificarAlumno"> 
           <input type="hidden" name="txtIdAlumno" value="${alumnodto.alumno.idAlumno}" /><br>
            <div class="container">            
                
                <div class="form-group col-md-6">
                    <label for="txtNombre">Nombre</label>
                    <input type="text" name="txtNombre" id="txtNombre" class="form-control" value="${alumnodto.alumno.nombre}"/>
                </div>

                <div class="form-group col-md-6">
                    <label for="txtApellido">Apellido</label>
                    <input type="text" name="txtApellido" id="txtApellido" class="form-control"  value="${alumnodto.alumno.apellido}"/>
                </div>
                <div class="form-group col-md-6">
                    <label for="cboSexo">Sexo</label>
                    <select name="cboSexo" id="cboSexo" class="form-control" value="${alumnodto.alumno.sexo}">
                        <option name="cboSexo" id="cboSexo">Masculino</option>
                        <option name="cboSexo" id="cboSexo">Femenino</option>
                        <option name="cboSexo" id="cboSexo" >Otros</option>
                    </select> 
                </div>
                <div class="form-group col-md-6"> 
                    <label for="txtFechaNacimiento">Fecha de nacimiento</label>
                    <input type="text" name="txtFechaNacimiento" id="txtFechaNacimiento" class="form-control" value="${alumnodto.alumno.fechaNacimiento}"/>
                </div>

                <div class="form-group col-md-6">
                    <label for="cboTipoDocumento">Tipo de documento</label>
                    <select name="cboTipoDocumento" id="cboTipoDocumento" class="form-control" value="${alumnodto.alumno.tipoDocumento}">
                        <option name="cboTipoDocumento" id="cboTipoDocumento">Documento Unico de Identidad</option>
                        <option name="cboTipoDocumento" id="cboTipoDocumento">Carnet de Extranjeria</option>
                        <option name="cboTipoDocumento" id="cboTipoDocumento">Reg. unico de constribuyentes</option>
                        <option name="cboTipoDocumento" id="cboTipoDocumento">Pasaporte</option>
                    </select>
                </div>

                <div class="form-group col-md-6">
                    <label for="txtDocumento">Documento</label>
                    <input type="text" name="txtDocumento" id="txtDocumento" class="form-control" value="${alumnodto.alumno.documento}"/>
                </div>

                <div class="form-group col-md-6">
                    <label for="txtDireccion">Direccion</label>
                    <input type="text" name="txtDireccion" id="txtDireccion" class="form-control" value="${alumnodto.alumno.direccion}"/>
                </div>

                <div class="form-group col-md-6">
                    <label for="txtTelefono">Telefono</label>
                    <input type="text" name="txtTelefono" id="txtTelefono" class="form-control" value="${alumnodto.alumno.telefono}" />
                </div>

                <div class="form-group col-md-6">
                    <label for="txtEmail">Email</label>
                    <input type="text" name="txtEmail" id="txtEmail" class="form-control" value="${alumnodto.alumno.email}"/>
                </div>        
