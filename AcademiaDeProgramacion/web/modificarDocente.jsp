...
<html>
    ...
    <body>
        ...
        <form method="POST" action="/AcademiaDeProgramacion/ModificarDocente"> 
            <input type="hidden" name="txtIdDocente" value="${docentedto.docente.idDocente}" />
            <div class="container">
                <div class="form-group col-md-6">
                    <label for="txtNombre">Nombre</label>
                    <input type="text" name="txtNombre" class="form-control" id="txtNombre" value="${docentedto.docente.nombre}"/>
                </div>

                <div class="form-group col-md-6">
                    <label for="txtApellido">Apellido</label>
                    <input type="text" name="txtApellido" id="txtApellido" class="form-control" value="${docentedto.docente.apellido}"/>
                </div>


                <div class="form-group col-md-6">
                    <label for="txtLegajo">Legajo</label>
                    <input type="text" name="txtLegajo" id="txtLegajo" class="form-control" value="${docentedto.docente.legajo}"/>
                </div>


                <div class="form-group col-md-6">
                    <label for="txtCorreoInstitucional">Correo Institucional</label>
                    <input type="text" name="txtCorreoInstitucional" id="txtCorreoInstitucional"  class="form-control" value="${docentedto.docente.correoInstitucional}"/>
                </div>
