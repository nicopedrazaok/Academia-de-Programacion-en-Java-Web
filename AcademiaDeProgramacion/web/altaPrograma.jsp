<%@page import="AccesoDatos.GestorProgramaBD"%>
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<jsp:useBean id="gestor" scope="request" class="AccesoDatos.GestorProgramaBD"/>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <br>  
        <div class="container">
            <h1>Alta de programas</h1>
        </div>
        <form action="/AcademiaDeProgramacion/AltaPrograma" method="POST" enctype="multipart/form-data">      
            <div class="container">
                ...
                <div class="form-group col-md-6">
                 ...
                 <div class="form-group col-md-6">
                <label for="fileName">Programa: </label>
                ...
                <div class="container">
                <input type="radio" name="rbtEstado" id="rbtEstado" value=1 />Habilitar
                <input type="radio" name="rbtEstado" id="rbtEstado" value=0 />Desabilitar
                </div>
                </div>
